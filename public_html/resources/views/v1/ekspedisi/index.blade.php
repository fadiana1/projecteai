    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#createNewProduct').click(function() {
                ...
                $('#modelHeading').html("Tambah ekspedisi");
            ...
            $('body').on('click', '.editProduct', function() {
                ...
                $.get("{{ route('admin.ekspedisi.index') }}" + '/' + product_id + '/edit', function(
                    data) {
                    $('#modelHeading').html("Edit ekspedisi");
            ...
            $('#saveBtn').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.ekspedisi.store') }}",
                    type: "POST",
                    dataType: 'json',
            ...
            $('body').on('click', '.deleteProduct', function() {
                ...
                Swal.fire({
                    ...
                    text: "Mengahapus data kelompok ekspedisi",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "DELETE",
                            url: "{{ route('admin.ekspedisi.store') }}" + '/' + product_id,
                            success: function(data) {
                                table.draw();
