            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="productForm" name="productForm" class="form-horizontal">
                        ...
                        <div class="form-group mb-3">
                            <label for="name" class="control-label mb-1">Kelompok Tani</label>
                            <fieldset class="form-group">
                                <select class="form-select @error('tani') is-invalid @enderror" id="tani"
                                    name="tani">
                        ...
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label" for="remember">
                                Harap Centang Jika Ingin Mengubah Data
                            </label>
                        </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('body').on('click', '.editProduct', function() {
                ...
                $.get("{{ route('admin.user.index') }}" + '/' + product_id + '/edit', function(
                    data) {
                    ...
                    $('#tani').find(":selected").val(data.tani_id)
                })
            });
